...
if DEVELOPMENT: 
    import sys
    sys.path.append('/home/user/somepath/caquitv')
    sys.path.append('/home/user/somepath/caquitv/external_apps')
    sys.path.append('/home/user/somepath/caquitv/local_apps')
